...
public class SeleniumReadTest {
	...
	void readTest() {
		...
		WebElement title = this.driver.findElement(By.xpath("/html/body/header/h1")); // gets title

		assertThat(title.getText()).isEqualTo("Call of Duty loadout");
