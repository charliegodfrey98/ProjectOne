...
public class SeleniumUpdateTest {
	...
	void updateTest() {
		...
		WebElement updateButton = this.driver.findElement(By.xpath("//*[@id=\"table-body\"]/tr[1]/td[10]/button"));

		updateButton.click();

		WebElement nameBar = this.driver.findElement(By.xpath("//*[@id=\"updateloadoutname\"]"));

		nameBar.sendKeys("Test");

		WebElement submitButton = this.driver.findElement(By.xpath("//*[@id=\"updateButton\"]"));
